...
abstract class Main {
    ...
    /**
     * Определяет тип значения параметра и возвращает значение, приведенное к данному типу
        ...
        try {
            if (Loader::includeModule('sale')) {
                ...
                if ($USER->IsAuthorized()) {
                    $basket = \Bitrix\Sale\Basket::loadItemsForFUser(\Bitrix\Sale\Fuser::getIdByUserId($USER->GetID()), \Bitrix\Main\Context::getCurrent()->getSite());
                }
                else {
