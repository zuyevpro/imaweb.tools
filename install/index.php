...
class imaweb_tools extends CModule {
    ...
    function InstallDB() {
        ...
        $path = getLocalPath('modules/imaweb.tools/install/db/mysql/install.sql');
        if ($path) {
...
//            $path = getLocalPath('modules/imaweb.tools/install/db/mysql/uninstall.sql');
//            if ($path) {
//                $path = $_SERVER['DOCUMENT_ROOT'] . $path;
//                global $DB;
//                $DB->RunSQLBatch($path);
...
//        }
    ...
    function InstallEvents() {
        ...
        $em->registerEventHandlerCompatible('main', 'OnPageStart', 'imaweb.tools', "\\Imaweb\\Tools\\Handlers", "redirectCheck");
    ...
    function UnInstallEvents() {
        ...
        $em->unRegisterEventHandler('main', 'OnPageStart', 'imaweb.tools', "\\Imaweb\\Tools\\Handlers", "redirectCheck");
